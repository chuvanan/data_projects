...
profs$nganh[grepl("chăn nuôi|thú y|(thủy|thuỷ) sản", profs$nganh, ignore.case = TRUE)] <- "Chăn nuôi"
...
profs$nganh[grepl("vật lý", profs$nganh, ignore.case = TRUE)] <- "Vật lý"
...
profs$nganh[grepl("điện|tự động", profs$nganh, ignore.case = TRUE)] <- "Điện tử"
profs$nganh[grepl("(vận tải|giao thông)", profs$nganh, ignore.case = TRUE)] <- "GTVT"
...
profs$nganh[grepl("nông|lâm", profs$nganh, ignore.case = TRUE)] <- "Nông nghiệp"
...
profs$nganh[grepl("nhiệt|luyện", profs$nganh, ignore.case = TRUE)] <- "Luyện kim"
profs$nganh[grepl("kinh tế", profs$nganh, ignore.case = TRUE)] <- "Kinh tế học"
profs$nganh[grepl("xây dựng|kiến trúc", profs$nganh, ignore.case = TRUE)] <- "XD-KT"
profs$nganh[grepl("mỏ|trái đất", profs$nganh, ignore.case = TRUE)] <- "KH trái đất"
...
profs$nganh[grepl("khảo cổ", profs$nganh, ignore.case = TRUE)] <- "Khảo cổ"
...
profs$nganh[grepl("^(hoá|hóa) học|thực phẩm", profs$nganh, ignore.case = TRUE)] <- "Hóa học"
profs$nganh[grepl("tin học|thông tin", profs$nganh, ignore.case = TRUE)] <- "CNTT"
profs$nganh[grepl("cơ khí|động lực", profs$nganh, ignore.case = TRUE)] <- "Cơ khí"
