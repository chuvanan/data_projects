...
new_outbreak_data$cumulative_count <- c(9692, 11791, 14380, 17205, 20438, 24324, 28018, 31161, rep(NA, 2)) # update actual outbreak here
...
par(family = "Carlito", cex = 1.1, mar = c(2.5, 4.1, 4.1, 2), bty = "n")
