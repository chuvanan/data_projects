...
outbreak <- outbreak[, c("country", "confirmed_cases", "deaths", "reference")]

## remove rows
outbreak <- outbreak[!grepl(pattern = "territories|As of|vte", outbreak$country), ]
