...
D3_1 <- count_response(fisf, D3_1_LABEL, index = "D3")
D3_2 <- count_response(fisf, D3_2_LABEL, index = "D3_2")
D3_3 <- count_response(fisf, D3_3_LABEL, index = "D3_3")
D3_4 <- count_response(fisf, D3_4_LABEL, index = "D3_4")
D3_5 <- count_response(fisf, D3_5_LABEL, index = "D3_5")
D3_6 <- count_response(fisf, D3_6_LABEL, index = "D3_6")
D3_7 <- count_response(fisf, D3_7_LABEL, index = "D3_7")

D3_2UNIQ <- count_response(fisf, D3_2_UNIQ_LABEL, index = "D3_2")
D3_5UNIQ <- count_response(fisf, D3_5_UNIQ_LABEL, index = "D3_5")
